...
// Load the helpers module using CommonJS require
const { helpers, SimpleCache } = require("../extension/scripts/utils/helpers.js");
...
describe("Helpers Utility Functions", () => {
  ...
  describe("escapeHtml", () => {
    ...
    it("should escape quotes", () => {
      ...
      const escaped = helpers.escapeHtml(input);
      // Note: textContent/innerHTML encoding doesn't escape quotes by default
      // The function escapes <, >, and & but not quotes (which is standard behavior)
  ...
  describe("retryWithBackoff", () => {
    ...
    it("should throw error after max retries", async () => {
      ...
      await expect(helpers.retryWithBackoff(mockFn, 3, 100)).rejects.toThrow("persistent failure");
    ...
    it("should handle zero retries", async () => {
      ...
      // With 0 retries, the loop doesn't run, so lastError is undefined
      // and throw undefined throws undefined
      try {
        await helpers.retryWithBackoff(mockFn, 0, 100);
  ...
  describe("isPRPage", () => {
    it("should return true for PR page", () => {
      ...
      expect(helpers.isPRPage()).toBeTruthy();
    });
    ...
    it("should return false for non-PR page", () => {
      ...
      expect(helpers.isPRPage()).toBeFalsy();
    });
  ...
  describe("formatRelativeTime", () => {
    ...
    it("should handle edge case of exactly 24 hours", () => {
      ...
      // At exactly 24 hours, hours=24 which is not > 24, so it shows "24 hours ago"
      expect(helpers.formatRelativeTime(timestamp)).toBe("24 hours ago");
    });
  });
  ...
  describe("truncateText", () => {
    ...
    it("should preserve unicode characters", () => {
      ...
      // truncateText doesn't add space before suffix, so "👋 Hello" + "..." = "👋 Hello..."
